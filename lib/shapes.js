...
const triangleEx = new Triangle("aaa", "blue", "red")
//console.log(triangleEx)
const svcode = triangleEx.generateSVG()
//console.log(svcode)
const circleEx = new Circle("aaa", "blue", "red")
const squareEx = new Square("aaa", "blue", "red")
//console.log(squareEx.generateSVG())
//console.log(circleEx.generateSVG())
const ellipseEx = new Ellipse("aaa", "blue", "red")
const rectangleEx = new Rectangle("aaa", "blue", "red")
//console.log(ellipseEx.generateSVG())
//console.log(rectangleEx.generateSVG())